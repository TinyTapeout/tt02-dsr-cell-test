...
ifneq ($(GATES),yes)
# normal simulation
VERILOG_SOURCES += $(PWD)/test/dffsr_tb.v $(PWD)/src/user_module_348378194290672212.v $(PWD)/src/cells.v
else
...
VERILOG_SOURCES += $(PWD)/test/dffsr_tb.v $(PWD)/src/user_module_348378194290672212.gl.v
endif
